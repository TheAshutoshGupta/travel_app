    ...
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row border-2 ">
        ...
        <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
            ...
            <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]">
                We want to be on reach of your journeys seeking the satisfaction of seeing the incorruptible bearuty of nature. We can help you on an adventure around the world in just one app.
            </p>
            <div className="my-11 flex flex-wrap gap-5">
                ...
                <p className="bold-16 lg_bold text-blue-70">198k
                    <span className="regular-16 lg:reular-20 ml-1">Excellent Reviews</span>
                </p>
            </div>
